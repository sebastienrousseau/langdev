...
<p align="center">
  <img src="assets/logo.svg" alt="langdev logo" width="140" />
</p>

<h1 align="center">langdev</h1>

<p align="center">
  Universal, portable, hardened development containers with TMUX IDE,
  Model Context Protocol (MCP) AI agent tooling, mobile WebTTY, and dotfiles bootstrap.
</p>

<p align="center">
  <a href="https://github.com/sebastienrousseau/langdev/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/langdev/ci.yml?style=for-the-badge&logo=github" alt="Build" /></a>
...
Clone any repository in the suite and spin up a complete, hardened terminal IDE in seconds:
...
`langdev` is the shared core foundation for a family of per-language development containers:
...
- **Center-Top (56% W, 70% H)**: Editor pane loaded with Neovim and language LSP.
- **Center-Bottom (56% W, 30% H)**: Integrated bash terminal.
